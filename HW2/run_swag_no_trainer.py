...
def parse_args():
    ...
    parser.add_argument(
        "--num_warmup_steps", type=int, default=0.1, help="Number of steps for the warmup in the lr scheduler."
    )
    parser.add_argument("--output_dir", type=str, default="./mc_ckpt", help="Where to store the final model.")
...
#             os.makedirs(args.output_dir, exist_ok=True)
    ...
    if args.dataset_name is not None:
        ...
        # print(args.train_file, args.validation_file)
